...
namespace datafromexceltryingon3tables.Migrations
{
    ...
    [Migration("20230502093316_addedAllRemainingTables")]
    partial class addedAllRemainingTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("datafromexceltryingon3tables.Models.MasterTable", b =>
                {
                    ...
                    b.Property<int>("businessUnitBuId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("datafromexceltryingon3tables.Models.MasterTable", b =>
                {
                    ...
                    b.HasOne("datafromexceltryingon3tables.Models.BusinessUnit", "businessUnit")
                        .WithMany()
                        .HasForeignKey("businessUnitBuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
